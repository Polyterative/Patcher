...
Canonical docs screenshots are the desktop JPEGs produced by the current E2E output. Mutating sync is allowed only after screenshot review and only against the guarded local checkout.
