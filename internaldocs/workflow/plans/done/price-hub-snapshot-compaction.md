...
- No RLS/policy/GRANT changes in scope. Supabase Cron was separately approved on 2026-08-31 for the snapshot worker: every three days at 00:00 UTC via pg_cron/pg_net, with the worker token held in Vault.
...
- 2026-08-31 — Owner approved recurring Price Hub snapshot-worker execution every three days at 00:00 UTC. The job invokes the bounded Edge Function through pg_net; its authorization token is held in Vault.
