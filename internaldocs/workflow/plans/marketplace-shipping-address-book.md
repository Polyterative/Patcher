...
- 2026-07-20 — E2E credentials are now persisted in the gitignored root `.env` (`E2E_TEST_EMAIL` / `E2E_TEST_PASSWORD`, auth-verified against Supabase). The blocked authenticated screenshot validation above can be re-run.
