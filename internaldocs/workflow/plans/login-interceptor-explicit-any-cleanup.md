...
- [ ] Archive this maintenance slice with validation evidence and no public documentation change.
...
- The explicit-`any` baseline drops by four without adding new entries.
