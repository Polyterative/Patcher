...
- [~] **LOW: Cross-entity Cool reactions (backend + gated shared UI local; production wiring blocked by remote migration/typegen reconciliation)** → [`plans/module-cool-appreciation-button.md`](./plans/module-cool-appreciation-button.md)
