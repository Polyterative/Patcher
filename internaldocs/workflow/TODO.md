...
- [ ] **Replace the flat tag list with a rich grouped-chip picker.** Reuse (or extract into a
...
- [ ] Add a **search input** at the top of the chip picker to filter visible tags in real-time.
...
- [ ] Add a small **AND / OR toggle** (`mat-button-toggle-group`) above the chip groups.
...
- [ ] Add a **tag-match relevance sort** to the module browser results. When one or more tags are
