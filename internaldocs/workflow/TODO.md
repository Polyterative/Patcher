...
- [~] **LOW: Cross-entity Cool reactions (backend + gated shared UI; production wiring blocked by remaining typegen drift)** → [`plans/module-cool-appreciation-button.md`](./plans/module-cool-appreciation-button.md)
