...
- [~] **HIGH: Authentication resilience — S2 recovery-session integrity implemented and QA-PASS; coordinator commit pending; S3/S4 remain** → [`plans/auth-resilience.md`](./plans/auth-resilience.md)
