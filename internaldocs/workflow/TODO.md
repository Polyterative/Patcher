...
- [~] **LOW: Cross-entity Cool reactions (backend + gated shared UI; production branch/release forbidden; typegen candidate-only)** → [`plans/module-cool-appreciation-button.md`](./plans/module-cool-appreciation-button.md)
