...
- [~] **HIGH: Authentication resilience — S1/S2 committed; S3 implemented and QA-PASS (coordinator commit pending); S4 next** → [`plans/auth-resilience.md`](./plans/auth-resilience.md)
