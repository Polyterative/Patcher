...
- [~] **HIGH: Marketplace — Purchase Price History (next: strategic plan; implementation/migrations still gated)** → [`plans/marketplace-purchase-price-history.md`](./plans/marketplace-purchase-price-history.md)
