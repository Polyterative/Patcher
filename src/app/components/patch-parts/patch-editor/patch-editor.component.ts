...
export class PatchEditorComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    //   })),
    //   // switchMap(x => this.backend.update.patch-parts(x)),
    //   switchMap(x => zip(this.backend.update.patch-parts(x))),
    //   withLatestFrom(this.dataService.updateSinglePatchData$),
    //   takeUntil(this.destroyEvent$)
    // )
    //     .subscribe(([x, a]) => this.dataService.updateSinglePatchData$.next(a));
