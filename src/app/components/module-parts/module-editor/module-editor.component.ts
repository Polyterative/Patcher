...
export class ModuleEditorComponent implements OnInit, OnDestroy {
  ...
  private buildFittedPanelCropPosition(imagePosition: CropperPosition): CropperPosition {
    return buildFittedPanelCropPosition(imagePosition, this.panelCropAspectRatio);
  }
  ...
  private scalePanelCropPosition(
    ...
    return scalePanelCropPosition(position, scaleFactor, imagePosition, this.panelCropAspectRatio);
  }
