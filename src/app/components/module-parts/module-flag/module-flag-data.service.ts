...
export const FLAG_CATEGORIES = [
  {value: 'wrong-specs', label: 'Wrong specs (HP, power, etc.)'},
  {value: 'missing-image', label: 'Missing panel image'},
  {value: 'duplicate', label: 'Duplicate module'},
  {value: 'other', label: 'Other'},
] as const;

export type FlagCategory = typeof FLAG_CATEGORIES[number]['value'];
